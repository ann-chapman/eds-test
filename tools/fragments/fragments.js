...
function handleFragmentSelect(actions, file, context) {
  ...
  actions.sendHTML(`<div class="tableWrapper"><table style="min-width: 25px;"><colgroup><col></colgroup><tbody><tr><td class="selectedCell"><p>fragment</p></td></tr><tr><td><p><a href="${fragmentUrl}">${fragmentUrl}</a></p></td></tr></tbody></table></div>`);
